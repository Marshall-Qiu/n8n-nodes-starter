...
export class QuidQuestionsOutputEmail implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Quid Questions Output Email',
		name: 'quid-questions-output-email',
		icon: 'file:search.svg',
		group: ['transform'],
		version: 1,
		description: 'Quid Questions Output Email',
		defaults: {
			name: 'Quid Questions Output Email',
		},
		inputs: ['main'],
